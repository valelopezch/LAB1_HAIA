...
class CatanGA:
    ...
    def evaluate(self, individual):
        ...
        for _ in range(self.num_games_per_individual):
        ...
        return (total_wins / self.num_games_per_individual,) 
